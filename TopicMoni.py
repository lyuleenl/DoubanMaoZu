...
# 核心逻辑 分析网页信息并匹配关键字
def analyAndCompile(url, textArr):
    global msg
    global craw
    firstKey = textArr[0]
    ...
    # 二级匹配关键字
    patternList = []
    for secondKey in textArr:
        if secondKey == firstKey:
            continue
        par=re.compile(secondKey)
        patternList.append(par)
    # 循环次数
    flag = 0
...
arr.append("【开车】")
arr.append("猫砂")
analyAndCompile("https://www.douban.com/group/656297/",arr)